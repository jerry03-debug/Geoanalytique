...
public class ParalleleDroiteOperation implements Operation {

    private Droite droite;
    private Point point;

    public ParalleleDroiteOperation(Droite droite, Point point) {
        this.droite = droite;
        this.point = point;
    }
    ...
    float pente = this.droite.getPente();
...
public String getTitle() {
    return "Parallele Droite Operation";
}
